...
public class javaStep {
    ...
    public void iHelloWorld() {
        ...
        String greeting = "Hi";
        String intro = "I'm Jasur";
        System.out.println(greeting + ", " + intro);

        String firstName = "Jasur";
        String lastName = "Botirov";
        ...
        System.out.println(firstName.equals("jasur"));
        System.out.println(firstName.contains("as"));

    }

    @Given("I perform actions with {string} and {string}")
    public void iPerformActionsWithAnd(String j1, String j2) {

        System.out.println("String 1: " + j1);
        System.out.println("String 2: " + j2);
        System.out.println("String 1: " + j1.toUpperCase());
        System.out.println("String 2: " + j2.toLowerCase());
        System.out.println("String 1: " + j1.length());
        System.out.println("String 2: " + j2.length());
        System.out.println("Exact comparison: == " + (j1 == j2));
        System.out.println("Exact comparison: equals " + j1.equals(j2));
        System.out.println("Exact comparison: equals ignoring case " + j1.equalsIgnoreCase(j2));
        System.out.println("Partial comparison: contains " + j1.toUpperCase().contains(j2.toUpperCase()));
    }

    @Given("I operate {int} and {int} numbers")
    public void iOperateAndNumbers(int n1, int n2) {
...
//        Using if statement:
        ...
        } else { System.out.println("Unsupported page: " + page);
        }
...
//    }
    ...
    public void iPrintThDayOfWeek(String days) {
